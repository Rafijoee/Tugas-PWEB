...
<<<<<<<< HEAD:app/registrasi.php
            <a href="login.php" type="submit" class="text-center bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 text-white font-medium rounded-md p-2 w-full transition duration-300 ease-in-out">Daftar</a>
========
...
>>>>>>>> bdd84637562d43597cef4955eb7c7c9e7a0b274f:registrasi.php
          </form>
          <div class="absolute bottom-0 left-0 right-0 -z-10">
            <svg class="w-full h-full" viewBox="0 0 1440 320" preserveAspectRatio="none">
              <path d="M0,0 L1440,320 L1440,0 L0,0 Z" fill="#F6D365"></path>
            </svg>
          </div>
        </div>
    </div>
